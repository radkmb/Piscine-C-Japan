...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/19 17:50:40 by rfukuda           #+#    #+#             */
/*   Updated: 2022/01/09 03:24:56 by rfukuda          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <unistd.h>

#define MAX_INDEX_SIZE 14
...
void	ft_print_memory_at(void *start_addr, unsigned int size, char *curr_addr)
{
	...
	ft_write_hex((unsigned int)curr_addr, 16, MAX_INDEX_SIZE);
	write(1, &": ", 2);
	index = 0;
	while (index++ < 16)
	{
...
int     main(void)
{
	...
	char str[] = "Bonjour les aminches\t\n\tc  est fou\ttout\tce quo n peut faire avec\t\n\tprint_memory\n\t\n\tlol.lol\n \0";
	i = 128;
